...
GO 
CREATE PROC dbo.deleteExtraAlojamento @identi int,@nome nvarchar(30),@nomeParque nvarchar(30), @localização nvarchar(30), @idEstada int 
AS
...
drop proc deleteExtraAlojamento
